...
function renderUser(user) {
  if (!user) {
    return `
      <div class="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-200">
        <div class="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-10 rounded-xl shadow-lg dark:shadow-gray-900/50">
          <div>
  ...
  return `
    <div class="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-200">
       <div class="max-w-md w-full bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg text-center dark:shadow-gray-900/50">
          <img src="${photoURL || ''}" alt="avatar" class="w-24 h-24 rounded-full mx-auto mb-6 border-4 border-blue-100 dark:border-blue-900/30" />
          <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-1">${displayName || email}</h2>
          <p class="text-sm text-gray-500 dark:text-gray-400 mb-8">${email || ''}</p>
          <button id="sign-out-btn" class="w-full flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
            Sign out
          </button>
       </div>
    </div>
