  ...
  modal.innerHTML = `
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden transform transition-all scale-100 dark:shadow-gray-900/50">
      <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center bg-gray-50/50 dark:bg-gray-700/30">
        <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100">Add New Record</h3>
        <button type="button" id="add-close-x" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors">
      ...
      <form id="add-form" class="p-6 space-y-5">
        ...
        <!-- Date -->
        <div>
          <label for="add-date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Date</label>
          <input id="add-date" type="date" required class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-gray-100 text-sm rounded-xl focus:ring-pink-500 focus:border-pink-500 block w-full p-2.5 transition-all dark:[color-scheme:dark]" />
        </div>

        <!-- Hours -->
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Hours</label>
          <div id="add-timepicker-container" class="border border-gray-200 dark:border-gray-700 rounded-xl p-4 bg-gray-50 dark:bg-gray-700/30 flex justify-center"></div>
        ...
        <div>
          ...
          <div class="flex gap-2 mb-2">
            <input id="add-est-input" type="text" placeholder="Enter name" class="flex-1 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-gray-100 text-sm rounded-xl focus:ring-pink-500 focus:border-pink-500 block p-2.5 transition-all" />
            <button type="button" id="add-name-btn" class="px-4 py-2 bg-pink-100 dark:bg-pink-900/40 text-pink-700 dark:text-pink-300 rounded-xl hover:bg-pink-200 dark:hover:bg-pink-900/60 font-medium transition-colors">Add</button>
          </div>
          ...
          <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Add multiple names. Hours will be applied to the first record.</p>
        </div>

        <!-- Buttons -->
        <div class="flex justify-end gap-3 pt-2">
          <button type="button" id="add-cancel" class="px-5 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-600 hover:text-gray-900 dark:hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-300 transition-all cursor-pointer">Cancel</button>
